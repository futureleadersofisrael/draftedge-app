...
const WEAKNESS_2_OPTIONS = [
  {
    id: "meaningful_place",
    label: "להיות במקום משמעותי שאני מאמין בו",
  },
  {
    id: "grow_personal_professional",
    label: "להתפתח ולהתחזק (גם אישית וגם מקצועית)",
  },
  {
    id: "life_advantage",
    label: "לצאת עם יתרון להמשך החיים",
  },
  {
    id: "smooth_no_complications",
    label: "לעבור את זה בצורה חלקה ובלי הסתבכויות",
  },
] as const;
...
export default function Page() {
  ...
  const handleContinue = () => {
    ...
    router.push("/candidate_flow_emotional_question_light_style");
  };
    ...
    >
      <main className="w-full max-w-[600px] flex flex-col items-center gap-12 relative z-0">
        <header className="text-center space-y-3">
          ...
          >
            מה המטרות המרכזיות שלך מהשירות הצבאי שלך?
          </h1>
          <p className="text-[#6B7280] text-lg font-medium">
            בחר את הדברים שהכי חשובים לך מהשירות
          </p>
